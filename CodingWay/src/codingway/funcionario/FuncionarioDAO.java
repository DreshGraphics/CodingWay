...
public class FuncionarioDAO extends GenericDAO<Funcionario> {
    ...
    public boolean excluir(Funcionario funcionario) {
        Object[] options = {"Sim", "Não"};
        if (funcionario.getId() != 0) {
            if (JOptionPane.showOptionDialog(null, "Deseja excluir o(a) Funcionário(a): " + funcionario.getNome()
                ...
                if (remover(funcionario)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Não foi possível excluir o(a) Funcionário(a) " + funcionario.getNome(),
