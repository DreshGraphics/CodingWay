 ...
 * @author Dresh
 */
public class TelaConsultarAlunoR extends javax.swing.JFrame {
    ...
    public void atualizarTabela(){
        ...
        tbAlunoReserva.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        tbAlunoReserva = new javax.swing.JTable();
        ...
        tbAlunoReserva.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tbAlunoReserva);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        int linha = tbAlunoReserva.getSelectedRow();
        if(linha == -1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultarAlunoR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultarAlunoR().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbAlunoReserva;
